...
export const services: Service[] = [
  {
    ...
    category: "drilling",
    summary: "Conventional and wireline diamond core drilling, suited to both shallow geotechnical investigations and deep exploration campaigns",
    body: "Diamond coring works in almost any ground and delivers reliable core throughout. We deploy diamond rigs for geotechnical work in urban and remote settings, greenfield exploration, and resource definition at operating mines.",
  ...
  },
  {
    ...
    body: "Directional drilling and coring services enable precise targeting of geological structures and ore bodies. We apply steering and deviation control to reach subsurface targets.",
  ...
  },
  {
    ...
    category: "drilling",
    summary: "Match the method to the ground.",
    body: "For open-hole work, we drill mud and air rotary using tricone, PDC, and DTH bits as the ground demands. Soft or hard, shallow or deep, we select the right setup to get the hole down cleanly and fast.",
  ...
  },
  {
    ...
    body: "Standard Penetration Testing measures soil resistance in place, driving a split-spoon sampler under a standardised hammer blow count. SPT N-values are a critical input for foundation design and geotechnical characterisation. Several of our rigs carry automatic SPT hammers.",
