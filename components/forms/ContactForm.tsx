...
export function ContactForm() {
  ...
  const inputCls =
    "w-full border-b border-deep-navy/20 bg-transparent px-0 py-3.5 font-display text-base text-deep-navy outline-none transition-[border-color,box-shadow] duration-200 placeholder:text-muted focus:border-[var(--color-amber-dim)] focus:[box-shadow:0_10px_18px_-12px_color-mix(in_srgb,var(--color-amber)_50%,transparent)] md:text-[15px]";
